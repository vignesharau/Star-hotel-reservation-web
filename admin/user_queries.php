...
adminLogin();
//User queries using seen condition from the table
if (isset($_GET['seen'])) {
      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="card border-0  mb-4" style="background-color:#B2A4FF;">
          <div class="card-body">
            ...
            <!-- Table -->
            <div class="table-responsive-md bg-light shadow-lg" style="height: 450px; overflow-y: scroll;">
