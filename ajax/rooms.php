  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    while($room_data = mysqli_fetch_assoc($room_res))
    {
      ...
      if(!$settings_r['shutdown']){
        ...
        $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-primary fw-bold w-100 text-white  shadow-none mb-2'>Book Now</button>";
      }
      // print room card
      $output.="
        <div class='card mb-4 border-0 shadow'>
          <div class='row g-0 p-3 align-items-center'>
            <div class='col-md-5 mb-lg-0 mb-md-0 mb-3'>
              <img src='$room_thumb' class='img-fluid h-100 rounded img-thumbnail'>
            </div>
            <div class='col-md-5 px-lg-3 px-md-3 px-0'>
              <h4 class='mb-3 fw-bold'>$room_data[name]</h4>
            ...
            <div class='col-md-2 mt-lg-0 mt-md-0 mt-4 text-center'>
              ...
              $book_btn
              <a href='room_details.php?id=$room_data[id]' class='btn  w-100 btn-outline-danger fw-bold shadow-none'>More details</a>
            </div>
          </div>
        </div>
      ";
